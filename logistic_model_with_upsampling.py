...
model1=Sequential()
model1.add(Dense(1, input_dim=32, kernel_initializer='normal', activation='sigmoid'))
...
model1.fit(X_train, Y_train, validation_data=(X_test, Y_test), epochs=1250, batch_size=25000)



compare=pd.DataFrame(dt.iloc[0:42000,0])
compare['model']=model1.predict(X_test)
compare.to_csv("compare2.csv")
